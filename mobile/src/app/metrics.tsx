...
const labels: Record<LocalMetricName, string> = {
  ...
  entry_updated: '修改记录', entry_deleted: '删除记录', entry_copied: '复制记录', meal_copied: '复制整餐', recipe_saved: '保存家庭菜谱', recipe_logged: '记录套餐', custom_food_created: '创建自定义食品', favourite_toggled: '切换收藏',
